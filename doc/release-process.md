...
* Update manpages, see [gen-manpages.sh](https://github.com/gn2509629/zeuscoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [zeuscoin-detached-sigs](https://github.com/gn2509629/zeuscoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/gn2509629/zeuscoin/releases/new) with a link to the archived release notes.
