...
Testnet3 has been deprecated and replaced with Testnet4. The server port has been changed to 19423 however the RPC port remains
the same (19422).

Testnet faucets can be located at:
- http://testnet.skullcoin.org
